...
public class SkyRenderersProcedure {
	...
	public static void renderStars(int amount, int seed, float yaw, float pitch, float roll, int color, boolean constant) {
		if (starBuffer == null || amount != SkyRenderersProcedure.amount || seed != SkyRenderersProcedure.seed) {
			SkyRenderersProcedure.amount = amount;
			SkyRenderersProcedure.seed = seed;
			RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
			RenderSystem.setShader(GameRenderer::getPositionShader);
			BufferBuilder bufferBuilder = Tesselator.getInstance().getBuilder();
	...
	public static void renderSky(TickEvent.RenderTickEvent event) {
		...
		try {
			...
			if (!pattern.matcher(effects.getName()).find())
				return;
			if (effects != SkyRenderersProcedure.effects) {
				SkyRenderersProcedure.effects = effects;
				SkyRenderersProcedure.customSky = (List<Consumer<Object[]>>) effects.getField("customSky").get(null);
			}
			SkyRenderersProcedure.customSky.add(consumer);
		} catch (Exception e) {
		}
	}
	...
	private static void execute(@Nullable Event event, ResourceKey<Level> dimension) {
		if (dimension == null)
			return;
		if (dimension == ResourceKey.create(Registries.DIMENSION, new ResourceLocation("adastraextra:deimos")) || dimension == ResourceKey.create(Registries.DIMENSION, new ResourceLocation("adastraextra:phobos"))) {
			renderStars(5000, 10842, 90, 0, 0, 255 << 24 | 255 << 16 | 255 << 8 | 255, false);
			RenderSystem.setShaderTexture(0, new ResourceLocation(("adastraextra" + ":textures/" + "sky/sun" + ".png")));
			renderSun(50, 255 << 24 | 255 << 16 | 255 << 8 | 255, false);
			RenderSystem.setShaderTexture(0, new ResourceLocation(("ad_astra" + ":textures/" + "environment/mars" + ".png")));
			renderTexture(20, 112, -50, 0, 255 << 24 | 255 << 16 | 255 << 8 | 255, false);
		}
		...
		if (dimension == ResourceKey.create(Registries.DIMENSION, new ResourceLocation("adastraextra:adrastea")) || dimension == ResourceKey.create(Registries.DIMENSION, new ResourceLocation("adastraextra:amalthea"))
				|| dimension == ResourceKey.create(Registries.DIMENSION, new ResourceLocation("adastraextra:metis")) || dimension == ResourceKey.create(Registries.DIMENSION, new ResourceLocation("adastraextra:thebe"))) {
			renderStars(5000, 10842, 90, 0, 0, 255 << 24 | 255 << 16 | 255 << 8 | 255, false);
			RenderSystem.setShaderTexture(0, new ResourceLocation(("adastraextra" + ":textures/" + "sky/sun" + ".png")));
			renderSun(30, 255 << 24 | 255 << 16 | 255 << 8 | 255, false);
			RenderSystem.setShaderTexture(0, new ResourceLocation(("adastraextra" + ":textures/" + "sky/jupiter" + ".png")));
			renderTexture(30, 24, -60, 0, 255 << 24 | 255 << 16 | 255 << 8 | 255, false);
		}
		if (dimension == ResourceKey.create(Registries.DIMENSION, new ResourceLocation("adastraextra:saturn"))) {
			renderStars(5000, 10842, 90, 0, 0, 255 << 24 | 255 << 16 | 255 << 8 | 255, false);
			RenderSystem.setShaderTexture(0, new ResourceLocation(("adastraextra" + ":textures/" + "sky/sun" + ".png")));
			renderSun(25, 255 << 24 | 255 << 16 | 255 << 8 | 255, false);
			RenderSystem.setShaderTexture(0, new ResourceLocation(("adastraextra" + ":textures/" + "sky/saturnringskybox" + ".png")));
			renderSkybox(0, 0, 0, 255 << 24 | 255 << 16 | 255 << 8 | 255, true);
		}
		if (dimension == ResourceKey.create(Registries.DIMENSION, new ResourceLocation("adastraextra:neptune"))) {
			renderStars(5000, 10842, 90, 0, 0, 255 << 24 | 255 << 16 | 255 << 8 | 255, false);
			RenderSystem.setShaderTexture(0, new ResourceLocation(("adastraextra" + ":textures/" + "sky/sun" + ".png")));
			renderSun(20, 255 << 24 | 255 << 16 | 255 << 8 | 255, false);
		}
		if (dimension == ResourceKey.create(Registries.DIMENSION, new ResourceLocation("adastraextra:uranus"))) {
			renderStars(5000, 10842, 90, 0, 0, 255 << 24 | 255 << 16 | 255 << 8 | 255, false);
			RenderSystem.setShaderTexture(0, new ResourceLocation(("adastraextra" + ":textures/" + "sky/sun" + ".png")));
			renderSun(15, 255 << 24 | 255 << 16 | 255 << 8 | 255, false);
			RenderSystem.setShaderTexture(0, new ResourceLocation(("adastraextra" + ":textures/" + "sky/uranusringskybox" + ".png")));
			renderSkybox(0, 0, 0, 255 << 24 | 255 << 16 | 255 << 8 | 255, true);
		}
	}
}
