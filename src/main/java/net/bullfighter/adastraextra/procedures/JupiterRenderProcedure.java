...
public class JupiterRenderProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, ResourceKey<Level> dimension) {
		...
		if (dimension == (ResourceKey.create(Registries.DIMENSION, new ResourceLocation("adastraextra:jupiter")))) {
			...
			renderSun(25, (float) (world.getTimeOfDay(Minecraft.getInstance().getPartialTick()) * 360.0F), (int) (255 << 24 | 255 << 16 | 255 << 8 | 255), false);
		}
	}
}
